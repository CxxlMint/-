...
class VkBot:
    def __init__(self, user_id):
        ...
        self._COMMANDS = ["ПРИВЕТ", "!ПОГОДА", "!ВРЕМЯ", "ПОКА", "!КОМАНДЫ", "!ЧИСЛО", '!МОНЕТКА', 'РЕГИСТРАЦИЯ КИЛЛЕР', '!ЦИТАТА']
    ...
    def _get_weather(city=str("Москва")) -> list:
        ...
        return 'В городе ' + city + ' сейчас ' + w.get_detailed_status() + ' и ' + str(w.get_temperature('celsius')['temp']) + ' градусов по Цельсию.'